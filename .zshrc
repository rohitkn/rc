...
alias cr='python ~/git/rohitkn/mongodb-rohit/kernel-tools/codereview/upload.py -y -s codereview.10gen.com -e rohit.nijhawan@10gen.com --jira_user rohit.nijhawan@10gen.com -m'
alias ls='ls -G' #I like color
alias l='ls -lFh'     #size,show type,human readable
alias la='ls -lAFh'   #long list,show almost all,show type,human readable
alias lr='ls -ltRFh'   #sorted by date,recursive,show type,human readable
...
export PATH=$PATH:/usr/local/apache-maven-3.2.2/bin
export GIT_EDITOR='mvim -f'
export GIT_DIFF_TOOL='gitdiff'
